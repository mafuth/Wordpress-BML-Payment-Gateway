...
class WOOCOMMERCE_bml_INTEGRATION extends WC_Payment_Gateway
{
    ...
    function __construct()
    {
        ...
        // global ID
        $this->id = "woocommerce_bml_integration";
        // Title of Gateway
        $this->method_title = __("BML Payment Gateway", 'woocommerce_bml_integration');
        // Gateway Description
        $this->method_description = __("BML mPOS Payment Gateway Plug-in for WooCommerce by mafuth", 'woocommerce_bml_integration');
        // Title in the vertical tab
        $this->title = __("BML mPOS", 'woocommerce_bml_integration');
    ...
    public function init_form_fields()
    {
        $this->form_fields = array(
            'enabled' => array(
                'title' => __('Enable / Disable', 'woocommerce_bml_integration') ,
                'label' => __('Enable this payment gateway', 'woocommerce_bml_integration') ,
                'type' => 'checkbox',
                'default' => 'no',
            ) ,
            'title' => array(
                'title' => __('Title', 'woocommerce_bml_integration') ,
                'type' => 'text',
                'desc_tip' => __('Payment title of checkout process.', 'woocommerce_bml_integration') ,
                'default' => __('Credit Card', 'woocommerce_bml_integration') ,
            ) ,
            'description' => array(
                'title' => __('Description', 'woocommerce_bml_integration') ,
                'type' => 'textarea',
                'desc_tip' => __('Payment title of checkout process.', 'woocommerce_bml_integration') ,
                'default' => __('Payment via credit card.', 'woocommerce_bml_integration') ,
                'css' => 'max-width:450px;'
            ) ,
            'icon_at_checkout' => array(
                'title' => __('Display Icon at checkout', 'woocommerce_bml_integration') ,
                'label' => __('Display the BML Logo alongside accepted payment methods during checkout', 'woocommerce_bml_integration') ,
                'type' => 'checkbox',
                'default' => 'yes',
            ) ,
            'api_login' => array(
                'title' => __('BML Merchant API Login', 'woocommerce_bml_integration') ,
                'type' => 'text',
                'desc_tip' => __('This is the API Login provided for BML mPOS when you signed up for an merchant account.', 'woocommerce_bml_integration') ,
            ) ,
            'api_key' => array(
                'title' => __('BML mPOS API Key', 'woocommerce_bml_integration') ,
                'type' => 'password',
                'desc_tip' => __('This is the API Key provided by BML when you signed up for the merchant account.', 'woocommerce_bml_integration') ,
            ) ,
            'security' => array(
                'title' => __('Security Level', 'woocommerce_bml_integration') ,
                'label' => __('Set Security Level', 'woocommerce_bml_integration') ,
                'type' => 'select',
                'options' => array(
                    0 => __('Standard', 'woocommerce_bml_integration') ,
                    1 => __('Strong', 'woocommerce_bml_integration') ,
                    2 => __('Strongest (Recommended)', 'woocommerce_bml_integration') ,
                ) ,
                'description' => __('Set the security Level of the Gateway.', 'woocommerce_bml_integration') ,
                'default' => 2,
            ) ,
            'environment' => array(
                'title' => __('BML mPOS Test Mode', 'woocommerce_bml_integration') ,
                'label' => __('Enable Test Mode', 'woocommerce_bml_integration') ,
                'type' => 'checkbox',
                'description' => __('This is the test mode of gateway.', 'woocommerce_bml_integration') ,
                'default' => 'no',
            )
        );
    }
    ...
    function check_bml_response_message()
    {
        ...
        */
        ...
        $payment_gateway = WC()
            ->payment_gateways
            ->payment_gateways() ['woocommerce_bml_integration'];
