 ...
 */
function woocommerce_bml_integration_transaction_id_column_header($columns)
{
    ...
    foreach ($columns as $column_name => $column_info)
    {
        ...
        {
            $new_columns['transaction_id'] = __('Transaction ID', 'woocommerce_bml_integration');
        }
    }

    return $new_columns;
}
add_filter('manage_edit-shop_order_columns', 'woocommerce_bml_integration_transaction_id_column_header', 20);
